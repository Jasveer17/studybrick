    ...
    return (
        ...
        >
            <div className="flex items-start gap-3">
                {/* Drag Handle */}
                <button
                    className={`mt-1 cursor-grab active:cursor-grabbing transition-colors ${isDark ? 'text-slate-500 hover:text-slate-300' : 'text-slate-300 hover:text-slate-500'}`}
                    {...attributes}
                    {...listeners}
                >
                ...
                <button
                    ...
                    className={`transition-colors p-1 opacity-0 group-hover:opacity-100 ${isDark ? 'text-slate-500 hover:text-red-400' : 'text-slate-300 hover:text-red-500'}`}
                >
